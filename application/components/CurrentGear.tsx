import { Web3sdkioNftMedia, useAddress, useNFT } from "@web3sdkio/react";
import { EditionDrop, NFT, SmartContract } from "@web3sdkio/sdk";
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <div style={{ outline: "1px solid grey", borderRadius: 16 }}>
          {playerNft && (
            <Web3sdkioNftMedia metadata={playerNft?.metadata} height={"64"} />
          )}
        </div>
        ...
        >
          {pickaxe && (
            // @ts-ignore
            <Web3sdkioNftMedia metadata={pickaxe.metadata} height={"64"} />
          )}
        </div>
      </div>
